...
class MatchBand(object):
    ...
    def __init__(self, minimum_score=None, maximum_score=None, num_source_words=None, num_segments=None):  # noqa: E501
        """MatchBand - a model defined in Swagger"""  # noqa: E501
