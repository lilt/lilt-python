...
class DocumentPretranslating(object):
    ...
    def __init__(self, id=None, import_in_progress=None, import_succeeded=None, import_error_message=None, is_processing=None, is_pretranslating=None, status=None):  # noqa: E501
        """DocumentPretranslating - a model defined in Swagger"""  # noqa: E501
        self._id = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DocumentPretranslating, dict):
