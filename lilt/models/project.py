...
class Project(object):
    ...
    def __init__(self, id=None, memory_id=None, srclang=None, trglang=None, srclocale=None, trglocale=None, name=None, state=None, due_date=None, archived=None, metadata=None, created_at=None, updated_at=None, document=None):  # noqa: E501
