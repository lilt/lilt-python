...
class JobCreateParameters(object):
    ...
    def __init__(self, name=None, language_pairs=None, file_ids=None, due=None, src_lang=None, src_locale=None, is_plural=None, workflow_template_id=None, workflow_template_name=None, local_vars_configuration=None):  # noqa: E501
    ...
    def workflow_template_name(self):
        """Gets the workflow_template_name of this JobCreateParameters.  # noqa: E501

        Name of the workflow template to be used, must be passed with teamId or look up will fail. If workflowTemplateId is passed it supercedes any other look up.  # noqa: E501

        :return: The workflow_template_name of this JobCreateParameters.  # noqa: E501
        :rtype: int
        """
    ...
    def workflow_template_name(self, workflow_template_name):
        """Sets the workflow_template_name of this JobCreateParameters.

        Name of the workflow template to be used, must be passed with teamId or look up will fail. If workflowTemplateId is passed it supercedes any other look up.  # noqa: E501

        :param workflow_template_name: The workflow_template_name of this JobCreateParameters.  # noqa: E501
        :type: int
        """
