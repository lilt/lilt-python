...
class ProjectStatus(object):
    ...
    def __init__(self, id=None, num_source_words=None, num_words_confirmed=None, num_words_reviewed=None, time_elapsed=None, time_elapsed_translation=None, time_elapsed_research=None, time_elapsed_review=None, resources=None):  # noqa: E501
