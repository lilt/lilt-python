...
class ProjectQuote(object):
    ...
    def __init__(self, id=None, num_source_words=None, num_words_new=None, num_segments_new=None, num_words_repetition=None, num_segments_repetition=None, resources=None, local_vars_configuration=None):  # noqa: E501
