...
class CreateApi(object):
    ...
    def delete_lilt_create_content(self, content_id, **kwargs):  # noqa: E501
        ...
        Delete a piece of Lilt Create content.  Example CURL: ``` curl --X --request DELETE 'https://api.lilt.com/v2/create/1234?key=API_KEY' ```    # noqa: E501
    ...
    def generate_lilt_create_content(self, template_params, **kwargs):  # noqa: E501
        ...
        Generate new Lilt Create content with the given parameters.  Example CURL: ``` curl --X --request POST 'https://api.lilt.com/v2/create?key=API_KEY' \\ --header 'Content-Type: application/json' \\ --data-raw '{   \"language\":\"en-US\",   \"template\":\"blog-post\",   \"templateParams\":{     \"contentLength\":\"100\",     \"language\":\"en-US\",     \"sections\":[],     \"summary\":\"a blog post about hiking\"     },   \"preferences\":{\"tone\":\"formal\",\"styleguide\":\"\"} }' ```    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_lilt_create_by_id(self, content_id, **kwargs):  # noqa: E501
        ...
        Get Lilt Create content by ID.  Example CURL: ``` curl --X --request GET 'https://api.lilt.com/v2/create/1234?key=API_KEY' ```    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_lilt_create_content(self, **kwargs):  # noqa: E501
        ...
        Get a list of all content that has been generated by Lilt Create.  Example CURL: ``` curl --X --request GET 'https://api.lilt.com/v2/create?key=API_KEY' ```    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_lilt_create_content_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[LiltCreateContent], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[LiltCreateContent]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_lilt_create_preferences(self, **kwargs):  # noqa: E501
        ...
        Get the stored preferences for Lilt Create.  Example CURL: ``` curl --X --request POST 'https://api.lilt.com/v2/create/preferences?key=API_KEY' ```    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def regenerate_lilt_create_content(self, content_id, **kwargs):  # noqa: E501
        ...
        Regenerate the given piece of content with the current parameters.  Example CURL: ``` curl --X --request GET 'https://api.lilt.com/v2/create/1234/create?key=API_KEY' ```    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_lilt_create_content(self, content_id, **kwargs):  # noqa: E501
        ...
        Update a piece of Lilt Create content.  Example CURL: ``` curl --X --request PUT 'https://api.lilt.com/v2/create/1234?key=API_KEY' \\ --header 'Content-Type: application/json' \\ --data-raw '{\"language\":\"de-DE\"}' ```    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_lilt_create_preferences(self, **kwargs):  # noqa: E501
        ...
        Update the stored preferences for Lilt Create.  Example CURL: ``` curl --X --request PUT 'https://api.lilt.com/v2/create/preferences?key=API_KEY' \\ --header 'Content-Type: application/json' \\ --data-raw '{\"tone\": \"formal\", \"styleguide\": \"\"}' ```    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
