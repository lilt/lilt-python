...
class FilesApi(object):
    ...
    def add_label(self, id, name, **kwargs):  # noqa: E501
        ...
        Add a label to a File.  Example CURL: ``` curl --X --request POST 'https://api.lilt.com/v2/files/labels?key=API_KEY&id=1' --header 'Content-Type: application/json' \\ --data-raw '{     \"name\": \"label_name\" }' ```   # noqa: E501
    ...
    def delete_file(self, id, **kwargs):  # noqa: E501
        ...
        Delete a File.  Example CURL command: ```   curl -X DELETE https://api.lilt.com/v2/files?key=API_KEY&id=123 ```    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def download(self, id, **kwargs):  # noqa: E501
        ...
        Download a File.  Example CURL: ``` curl --X --request GET 'https://api.lilt.com/v2/files/download?key=API_KEY&id=1' ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def remove_label(self, id, name, **kwargs):  # noqa: E501
        ...
        Remove a label from a File.  Example CURL: ``` curl --X --request DELETE 'https://api.lilt.com/v2/files/labels?key=API_KEY&id=1&name=label_name' ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
