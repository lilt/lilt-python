...
class MemoriesApi(object):
    ...
    def delete_segment_from_memory(self, id, segment_id, **kwargs):  # noqa: E501
        ...
        Delete a segment from a memory.  ```   curl -X DELETE https://api.lilt.com/v2/memories/segment?key=API_KEY&id=ID&segment_id=$SEGMENT_ID ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def download_termbase(self, id, **kwargs):  # noqa: E501
        ...
        Downloads the termbase export for the given memory as a CSV file.  Ensure you first call the `/2/memories/termbase/export` endpoint to start the export process before you try to download it.  ```   curl -X GET https://api.lilt.com/v2/memories/termbase/download?key=API_KEY&id=ID ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def export_termbase(self, id, **kwargs):  # noqa: E501
        ...
        Exports the termbase entries for the given memory into a CSV file.  Calling this endpoint will begin the export process in the background. Check that the processing is complete by polling the `GET /2/memories` endpoint. When the `is_processing` value is 0 then call the `POST /2/memories/termbase/download` endpoint.  ```   curl -X POST https://api.lilt.com/v2/memories/termbase/export?key=API_KEY&id=ID ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
