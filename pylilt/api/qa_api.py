...
class QAApi(object):
    ...
    def qa_check(self, target, trglang, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.qa_check_with_http_info(target, trglang, **kwargs)  # noqa: E501
            return data
    ...
    def qa_check_with_http_info(self, target, trglang, **kwargs):  # noqa: E501
        ...
        if ('target' not in params or
            ...
            raise ValueError("Missing the required parameter `target` when calling `qa_check`")  # noqa: E501
        # verify the required parameter 'trglang' is set
        if ('trglang' not in params or
                params['trglang'] is None):
            raise ValueError("Missing the required parameter `trglang` when calling `qa_check`")  # noqa: E501
