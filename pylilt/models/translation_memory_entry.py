...
class TranslationMemoryEntry(object):
    ...
    def __init__(self, source=None, target=None, score=None, metadata=None):  # noqa: E501
        """TranslationMemoryEntry - a model defined in Swagger"""  # noqa: E501
        self._source = None
        self._target = None
        self._score = None
        self._metadata = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TranslationMemoryEntry, dict):
