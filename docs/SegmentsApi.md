...
[**segments_review_unlock_post**](SegmentsApi.md#segments_review_unlock_post) | **POST** /segments/review/unlock | Unaccept and unlock segments
...
# **segments_review_unlock_post**
> list[float] segments_review_unlock_post(body)
...
with lilt.ApiClient(configuration) as api_client:
    ...
    try:
        # Unaccept and unlock segments
        api_response = api_instance.segments_review_unlock_post(body)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling SegmentsApi->segments_review_unlock_post: %s\n" % e)
```
